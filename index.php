...
if(isset($_POST['envoyerLivre'])){
	...
	$autorLivre = $_POST['auteurTitre'];
	$nbPageLivre = $_POST['nbPage'];
	$editeurLivre = $_POST['editeurLivre'];
	$biblioLivre = $_POST['biblioChoix'];
	if($biblioLivre == 1){
		$i = new Book($titreLivre,$autorLivre,$editeurLivre,$nbPageLivre);
		$biblio->addBook($i);
	}
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
              <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="remove.php">Supp</a>
                </li>
                <li class="nav-item">
...
<form class="form-horizontal" method="POST">
	<fieldset>
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label" for="nbPage">Nombre de pages</label>  
		  <div class="col-md-4">
		  <input id="nbPage" name="nbPage" type="text" placeholder="145" class="form-control input-md">
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label" for="editeurLivre">Editeur</label>  
		  <div class="col-md-4">
		  <input id="editeurLivre" name="editeurLivre" type="text" placeholder="Hatier" class="form-control input-md" required="">
		...
		<!-- Text input-->
		<div class="form-group">
		  <label class="col-md-4 control-label" for="auteurTitre">Auteur</label>  
		  <div class="col-md-4">
		  <input id="auteurTitre" name="auteurTitre" type="text" placeholder="Hugo" class="form-control input-md" required="">
		...
		<!-- Button -->
		<div class="form-group">
		  <label class="col-md-4 control-label" for="envoyerLivre">Ajouter Livre</label>
		  <div class="col-md-4">
		    <button id="envoyerLivre" name="envoyerLivre" class="btn btn-primary">Ajouter !</button>
		  </div>
		</div>
	</fieldset>
</form>
